"""Service layer for the townlight_core LLM model registry.
...
internal townlight_core code that needs the active model's metadata.
"""
...
from townlight_core.llm.context import DEFAULT_CONTEXT_WINDOW
