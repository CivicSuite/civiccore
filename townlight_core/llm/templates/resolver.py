...
from townlight_core.llm.templates.exceptions import PromptTemplateNotFoundError
from townlight_core.llm.templates.models import PromptTemplate
from townlight_core.llm.templates.overrides import OVERRIDE_REGISTRY

# NOTE (CivicSuite -> Townlight rebrand): CIVICCORE_DEFAULT_APP's name and its
# literal "civiccore" value are intentionally NOT renamed here. This value is
# a sentinel already persisted as `consumer_app='civiccore'` in every
# consuming module's prompt_templates rows; renaming it would silently break
# resolution of every already-deployed default template. Only the import
# paths above (civiccore.* -> townlight_core.*) changed for this rename.
