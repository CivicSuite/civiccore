...
<!-- Project-specific items accumulate here. When the auditor surfaces a new drift pattern,
     add it as a checklist item AND add the longer entry in CivicCore_AUDIT_PROTOCOL.md
     section 22.
...
- `C:\Users\scott\OneDrive\Desktop\Claude\CIVICCORE_AUDIT_GATE.md` - the short mandatory gate auditors read every turn.
